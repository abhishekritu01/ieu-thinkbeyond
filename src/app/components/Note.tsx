...
const Note = () => {
  return (
    <div className="w-full bg-black py-6 px-4 sm:px-6 md:px-10 rounded-xl shadow-lg border border-gray-700 flex flex-col sm:flex-row items-center justify-center gap-4 hover:shadow-xl transition-all duration-300">
